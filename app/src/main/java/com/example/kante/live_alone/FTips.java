...
public class FTips extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //피드 카드뷰 생성
        recyclerView = (RecyclerView) v.findViewById(R.id.feeds_tips);
        ...
        mAdapter = new RecyclerAdapter(getContext(), mArrayList, R.layout.fragment_tips);
    ...
    private void getListItems(){
        ...
        fs.collection("posts").orderBy("created_at", Query.Direction.DESCENDING).whereEqualTo("category","FTips").get()
